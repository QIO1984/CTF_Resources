...
->![rentry.org/madnotehacks](https://i.postimg.cc/fTgMtPs9/unnamed-1.png)<-
#!~fuchsia;%Cyan%MADNOTE HACKS%%~!

####->A Collection of Links to Tools, Resources, and Guides for Cybersecurity, Hacking, and CTF Events<-
___
%Cyan%**Note**%%: The headings in part 1 of this guide align with domains of the [National Cyber League's](https://nationalcyberleague.org/competition) CTF competition. Additionally, I acknowledge that there are many excellent paid tools and resources in the categories below. This list is intended to provide **FOSS resources** related to cybersecurity and ethical hacking, so for the most part, paid tools have been excluded.
___

# 🔍 %Cyan%Open Source Intelligence (OSINT)%%  

## 🗂️ %Fuchsia%Meta-Resources%%
- **[OSINT Framework](https://osintframework.com/)**  
  *An interactive chart linking various OSINT tools and resources.*  
- **[Ohshint Blog](https://ohshint.gitbook.io/oh-shint-its-a-blog)**  
...
- **[Cipher387 on GitHub](https://github.com/cipher387/osint_stuff_tool_collection)**  
  *A well-curated collection of OSINT tools and resources.*  

## 🕵️ %Fuchsia%Websites, Applications, and CLI Tools%%
...
## 📁 %Fuchsia%FTP Search Tools%%
- **[Napalm FTP Indexer](https://searchftps.net)**  
  *Search engine indexing publicly accessible FTP servers.*  
- **[Freewareweb FTP Keyword Search](https://www.freewareweb.com/ftpsearch.shtml)**  
  *Searches thousands of public FTP servers by keyword.*  
- **[Mamont FTP Search Engine](https://www.mmnt.ru/int/)**  
...
## 🌐 %Fuchsia%DNS & Network Reconnaissance Tools%%
- **[Netcraft Recon Tools](https://www.netcraft.com/tools/)**  
  *Suite of tools for website reconnaissance and threat analysis.*  
- **[Netcraft Website Recon](https://sitereport.netcraft.com/)**  
...
- **[Domain Tools Whois Lookup](https://whois.domaintools.com)**
 *A tool for looking up domain information, including ownership and registration details.*
- **[Pentest-Tools](https://www.pentest-tools.com)**  
...
## 👥 %Fuchsia%People & Social Media Tools%%
...
## 📡 %Fuchsia%IoT & SCADA Search Engines%%
...
## 📊 %Fuchsia%Traceroute & Network Analysis Tools%%
...
## 🛡 %Fuchsia%Online Malware Analysis%%
...
## 🎓 %Fuchsia%OSINT Education%%
- **[Heath Adams OSINT Course](https://www.youtube.com/watch?v=qwA6MmbeGNo)**  
  *A 4.5-hour masterclass in OSINT techniques by The Cyber Mentor.*  
- **[ITSEC OSINT Guide](https://itsec.group/blog-post-osint-guide-part-1.html)**  
...
- **[Cryptography Toolbox](https://toolbox.itsec.tamu.edu/)**
 *A collection of cryptographic tools for performing various cryptographic functions like hashing and encryption.*
- **[DevGlan Cryptography](https://www.devglan.com/cryptotools/cryptography-tools)**  
...
- **[Ubuntu Public Keyserver](https://keyserver.ubuntu.com/)**
- **[AperiSolve](https://www.aperisolve.com/)**: *A tool to decode hidden information within image files using steganography techniques.*
 *A keyserver maintained by Ubuntu for managing PGP keys, often used in open-source software distributions.*

### 🎓 %Fuchsia%Cryptography Education%%
...
- **[Hashcat Example Table](https://hashcat.net/wiki/doku.php?id=example_hashes)**  
...
- **[Ophcrack SourceForge](https://ophcrack.sourceforge.io/)**
...
- **[Metadata2Go - View File Metadata](https://www.metadata2go.com/view-metadata)**
...
# 📡 %Cyan%Network Traffic Analysis%% 

---

# 🔎 %Cyan%Scanning and Recon%% 

---

# 🌍 %Cyan%Web Application Exploitation%%
### 🔒 %Fuchsia%Tools%%
- **[Burp Suite](https://portswigger.net/burp)**  
  *A leading web vulnerability scanner and penetration testing tool.*  
- **[SiriHash](https://www.srihash.org/)**  
...
### 🎓 %Fuchsia%Web App Security Education%%
- **[OWASP Top 10](https://owasp.org/www-project-top-ten/)**  
  *A crucial guide to web application vulnerabilities.*  

# 📶 %Cyan%Wireless Access Exploitation%% 

---

# 💥 %Cyan%Enumeration and Exploitation%% 

---

# 🛡 %Cyan%Security-Focused Operating Systems%%  
...
# 🎶 %Cyan%MADNOTE'S PLAYLIST%%  
#### 🎧 *A collection of atmospheric, minimal-lyric music to enhance focus and hacking vibes.*

| %Fuchsia%[Chillstep/Future Garage Mix for Deep Programming and Work - Chill Music Lab](https://youtu.be/MC1jEQOfqEw?si=VjcNnEgvmmzJRaPZ)%% | %Fuchsia%[D E B R I S - a Spacewave Mix - by I N E X E D](https://youtu.be/SanYFUB_3-w?si=CRFWjy6YZ7gb0_wl)%% |
| --- | --- |
| [![Chillstep & Future Garage Mix — Music for Deep Programming and Work - Chill Music Lab](https://img.youtube.com/vi/MC1jEQOfqEw/hqdefault.jpg)](https://youtu.be/MC1jEQOfqEw?si=VjcNnEgvmmzJRaPZ) | [![D E B R I S - a Spacewave Mix - by I N E X E D](https://img.youtube.com/vi/SanYFUB_3-w/hqdefault.jpg)](https://youtu.be/SanYFUB_3-w?si=CRFWjy6YZ7gb0_wl) |

| %Fuchsia%[N E T R U N vol 1 - a Retrowave/Synthwave Mix - by I N E X E D](https://youtu.be/S7i3ugniyjg?si=ATRD6mV9tK3giU5y)%% | %Fuchsia%[G R O O V E - a Chillwave/Retrowave Mix - by I N E X E D](https://youtu.be/qsScP8EzK_s?si=79JFFV3ZspyOFvAs)%% |
| --- | --- |
| [![N E T R U N vol 1 - a Retrowave/Synthwave Mix - by I N E X E D](https://img.youtube.com/vi/S7i3ugniyjg/hqdefault.jpg)](https://youtu.be/S7i3ugniyjg?si=ATRD6mV9tK3giU5y) | [![G R O O V E - a Chillwave/Retrowave Mix - by I N E X E D](https://img.youtube.com/vi/qsScP8EzK_s/hqdefault.jpg)](https://youtu.be/qsScP8EzK_s?si=79JFFV3ZspyOFvAs) |
